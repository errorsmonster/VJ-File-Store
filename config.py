...
ADMINS = int(environ.get("ADMINS", "6072149828"))
...
CDB_NAME = environ.get("CDB_NAME", "test")
DB_URI = environ.get("DB_URI", "mongodb+srv://akmonsterprogrammer:S.Aruna1155182089@test.zyj7rhx.mongodb.net/?retryWrites=true&w=majority&appName=test")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "MrAK_testbot") # your bot username without @
...
class Var(object):
    MULTI_CLIENT = False
    name = str(getenv('name', 'MrAK_testbot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002141251057'))
